...
public class Sort {
  ...
  public static void t1() {
    ...
    MyPriorityQueue<Integer> pq = new ListPQ2<Integer>(new DefaultComparator());
  ...
  public static void t2() {
   ...
   class BalanceComparator<T extends Account> implements Comparator<T> {
    ...
    MyPriorityQueue<Account> pq = new ListPQ2<Account>(new BalanceComparator());
  ...
  public static void t3() {
    ...
    MyPriorityQueue<Account> pq = new ListPQ2<Account>(new LoyaltyComparator());
  ...
  public static void t4() {
    ...
    MyPriorityQueue<Integer> pq = new ListPQ2<Integer>(new ReverseComparator());
